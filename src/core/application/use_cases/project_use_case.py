...
class ProjectUseCase(IProjectUseCase):
    ...
    def add_project(self, add_project_dto: ProjectDtos.AddProjectDto) -> ResponseDto[ProjectDtos.ProjectResponseDto]:
        if len(add_project_dto.name) > 30:
            return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'Name length cannot be more than 30 letters.')

        if add_project_dto.description is not None:
            if len(add_project_dto.description) > 150:
                return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'Description length cannot be more than 150 letters.')

        project: Project | None = self.project_repository.get_project_by_name(add_project_dto.name)
        if project is not None:
            return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'A project with the same name already exists.')
        ...
        return ResponseDto[ProjectDtos.ProjectResponseDto](ProjectFactory.map_to_project_response_dto(project))
    ...
    def get_project(self, project_id: int) -> ResponseDto[Project]:
        ...
        if project is None:
            return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'Project does not exist.')
    ...
    def get_projects(self) -> ResponseDto[Sequence[ProjectDtos.ProjectResponseDto]]:
        ...
        return ResponseDto[Sequence[ProjectDtos.ProjectResponseDto]](project_response_dtos)
    ...
    def edit_project(self, edit_project_dto: ProjectDtos.EditProjectDto) -> ResponseDto[ProjectDtos.ProjectResponseDto]:
        if edit_project_dto.new_name is None and edit_project_dto.new_description is None:
            return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'Enter a value to edit.')
        ...
        if edit_project_dto.new_name is not None:
            if len(edit_project_dto.new_name) > 30:
                return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'New name length cannot be more than 30 letters.')
        ...
        if edit_project_dto.new_description is not None:
            if len(edit_project_dto.new_description) > 150:
                return ResponseDto[ProjectDtos.ProjectResponseDto](None, False, 'New description length cannot be more than 150 letters.')
